  ...
  return (
    <div className="flex h-full gap-2">
      <Link
        ...
        className="group relative flex h-full min-h-16 w-full flex-col items-center justify-center gap-0.5 overflow-hidden rounded-xl bg-[#0a3d62] text-white ring-1 ring-white/5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-10px] hover:shadow-[#2867b2]/60"
      >
      ...
      <Link
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="group relative flex h-full min-h-16 w-full flex-col items-center justify-center gap-0.5 overflow-hidden rounded-xl bg-zinc-950 text-white ring-1 ring-white/5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-10px] hover:shadow-pink-500/60"
      >
